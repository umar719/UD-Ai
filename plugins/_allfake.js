...
global.fakefb = {
        ...
        global.fvn = {
            ...
            { remoteJid: "923184571668-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "ImUmar","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
       ...
       key: {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "923184671668-1625305606@g.us",
                   "inviteCode": "null",
                   "groupName": "UD Ai", 
                   "caption": wm, 
                   'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')
       ...
       global.fimg = {
		...
		global.fimgv = {
            ...
            key: { 
                 fromMe: false,
                 participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "923184671668-1625305606@g.us" } : {}) 
                       },
            message: { 
                        "videoMessage": { 
                        "title": wm,
